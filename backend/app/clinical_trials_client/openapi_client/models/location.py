...
class Location(BaseModel):
    ...
    city: Optional[StrictStr] = Field(default=None, description="State/province or city name")
    state: Optional[StrictStr] = Field(default=None, description="State/province or city name")
    zip: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    contacts: Optional[List[Contact]] = None
    geo_point: Optional[GeoPoint] = Field(default=None, alias="geoPoint")
    __properties: ClassVar[List[str]] = ["facility", "status", "city", "state", "zip", "country", "contacts", "geoPoint"]
